...
public class AdvancedCraftingTableHandler {

	public static AdvancedCraftingTableHandler instance = new AdvancedCraftingTableHandler();
	...
	public void addShapedRecipe(ItemStack output, Object ... inputs){
		...
		AdvancedShapedRecipes shapedrecipes = new AdvancedShapedRecipes(j, k, aitemstack, output);
		this.recipes.add(shapedrecipes);
	}

	public void addShapelessRecipe(ItemStack itemStack, Object ... inputs){
		...
		this.recipes.add(new AdvancedShapelessRecipes(itemStack, arraylist));
	}
